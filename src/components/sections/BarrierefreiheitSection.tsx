...
const items = ["Platz für bis zu 6 Rollstühle", "Elektrische Rampen für einfachen Einstieg", "Klimatisierte Fahrzeuge", "Erfahrene und einfühlsame Fahrer", "Flexible Buchung und Tourenplanung"];
    ...
    <section id="barrierefreiheit" style={{ backgroundColor: "var(--bg-off)", padding: "7rem 2.5rem", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center", position: "relative" }} className="barrier-grid">
        ...
        <div ref={right.ref} className={`reveal-right ${right.visible ? "visible" : ""}`}>
          <div className="section-label">♿ Barrierefreiheit</div>
          <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2rem, 3.5vw, 2.9rem)", lineHeight: 1.15, marginBottom: "1.25rem", fontWeight: 700, color: "var(--text-heading)" }}>Mobilität für alle Menschen</h2>
          <p style={{ color: "var(--text-body)", lineHeight: 1.85, fontSize: "1rem", marginBottom: "2rem", fontFamily: "var(--font-body)" }}>Barrierefreier Transport ist unser Herzstück. Unsere speziell ausgestatteten Fahrzeuge ermöglichen es Rollstuhlfahrern, bequem sitzen zu bleiben. Modernster Komfort, Klimaanlage und erfahrene Fahrer sorgen für eine sichere und angenehme Fahrt.</p>
