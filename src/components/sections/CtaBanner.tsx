  ...
  return (
    <section style={{ background: "linear-gradient(135deg, #DB0F10 0%, #FF2D2E 100%)", padding: "6rem 2.5rem", position: "relative", overflow: "hidden" }}>
      ...
      <div ref={ref} className={`reveal ${visible ? "visible" : ""}`} style={{ maxWidth: "720px", margin: "0 auto", textAlign: "center", position: "relative" }}>
        <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2rem, 4vw, 3rem)", color: "white", lineHeight: 1.2, marginBottom: "1rem", fontWeight: 700 }}>{t.ctaBanner.title}</h2>
        <p style={{ color: "rgba(255,255,255,0.88)", fontSize: "1.05rem", lineHeight: 1.7, marginBottom: "2.25rem", fontFamily: "var(--font-body)" }}>{t.ctaBanner.subtitle}</p>
