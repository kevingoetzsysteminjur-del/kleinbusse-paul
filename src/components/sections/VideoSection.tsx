...
export default function VideoSection() {
  ...
  return (
    <section ref={ref} style={{ backgroundColor: "#1A1A2E", padding: "7rem 2.5rem", position: "relative", overflow: "hidden" }}>
      {/* Background glow */}
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative" }}>
        ...
        >
          ...
          <h2 style={{ fontFamily: "var(--font-heading), 'Playfair Display', serif", fontSize: "clamp(2rem, 3.5vw, 2.9rem)", fontWeight: 700, color: "white", lineHeight: 1.15, marginBottom: "1rem" }}>
        ...
        >
          ...
          <div style={{ position: "relative", aspectRatio: "16/9", borderRadius: "16px", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.5)", border: "1px solid rgba(255,255,255,0.08)" }}>
            <iframe
              src="https://www.youtube.com/embed/hvQ-Qc-frHI"
